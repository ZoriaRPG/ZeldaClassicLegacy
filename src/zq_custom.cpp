...
static DIALOG linktile_dlg[] =
{
    ...
    // DEFENSE TAB BEGINS
    // 121 (Link defenses)
    { d_dummy_proc,                        7,      33,    305,    183,    0,                      0,                       0,    0,          0,          0, (void*)linktile_defense_tabs,    NULL, (void*)linktile_dlg },
...
int onCustomLink()
{
    ...
    {
        linktile_dlg[145 + i].d1 = link_defence[wEnemyWeapons+i+1];
    }
    linktile_dlg[162].d1 = link_defence[wFire];
    linktile_dlg[163].d1 = link_defence[wBomb];
    linktile_dlg[164].d1 = link_defence[wRefMagic];
    linktile_dlg[165].d1 = link_defence[wRefFireball];
    linktile_dlg[166].d1 = link_defence[wRefRock];
    linktile_dlg[167].d1 = link_defence[wRefBeam];

    linktile_dlg[179].d1 = link_defence[wScript1];
    linktile_dlg[180].d1 = link_defence[wScript2];
    linktile_dlg[181].d1 = link_defence[wScript3];
    linktile_dlg[182].d1 = link_defence[wScript4];
    linktile_dlg[183].d1 = link_defence[wScript5];
    linktile_dlg[184].d1 = link_defence[wScript6];
    linktile_dlg[185].d1 = link_defence[wScript7];
    linktile_dlg[186].d1 = link_defence[wScript8];
    linktile_dlg[187].d1 = link_defence[wScript9];
    linktile_dlg[188].d1 = link_defence[wScript10];
    ...
    do
    {
        ...
        {
            saved = false;
            set_bit(quest_rules, qr_LTTPCOLLISION, (linktile_dlg[189].flags & D_SELECTED) ? 1 : 0);
            set_bit(quest_rules, qr_LTTPWALK, (linktile_dlg[192].flags & D_SELECTED) ? 1 : 0);
            zinit.link_swim_speed = (linktile_dlg[194].d1 == 0) ? 50 : 67;

            //Save Link defenses
            for (int i = 0; i < wMax - wEnemyWeapons - 1; i++)
            {
                link_defence[wEnemyWeapons + i + 1] = linktile_dlg[145 + i].d1;
            }
            link_defence[wFire] = linktile_dlg[162].d1;
            link_defence[wBomb] = linktile_dlg[163].d1;
            link_defence[wRefMagic] = linktile_dlg[164].d1;
            link_defence[wRefFireball] = linktile_dlg[165].d1;
            link_defence[wRefRock] = linktile_dlg[166].d1;
            link_defence[wRefBeam] = linktile_dlg[167].d1;

            link_defence[wScript1] = linktile_dlg[179].d1;
            link_defence[wScript2] = linktile_dlg[180].d1;
            link_defence[wScript3] = linktile_dlg[181].d1;
            link_defence[wScript4] = linktile_dlg[182].d1;
            link_defence[wScript5] = linktile_dlg[183].d1;
            link_defence[wScript6] = linktile_dlg[184].d1;
            link_defence[wScript7] = linktile_dlg[185].d1;
            link_defence[wScript8] = linktile_dlg[186].d1;
            link_defence[wScript9] = linktile_dlg[187].d1;
            link_defence[wScript10] = linktile_dlg[188].d1;
        }
        else if (ret == 168)
        {
